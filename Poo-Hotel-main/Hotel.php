...
class Hotel
{
    ...
    {
        $calculNbChambre = count($this->nbDeChambres) - count($this->reservationsHotel);
        echo '<h2>'.$this->nom.'</h2>';
        ...
        echo "<span>nombre de chambres dispo: ".$calculNbChambre."</span><br>";
    }
    ...
    public function infosHotelReservation()
    {
        ...
        {
            echo'<span class="btn btn-success"> '.count($this->reservationsHotel).' réservations</span><br>';
            foreach($this->reservationsHotel as $reservation)
            {
                echo $reservation."<br>";
            }
    ...
    {
        echo '<table class="table table-hover" ><th>Chambre </th><th> Prix</th><th> Wifi</th><th> Etat</th>';
